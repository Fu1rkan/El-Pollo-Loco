...
class Character extends MovableObject {
    ...
    /** @type {number[]} Timeout ids used by character sounds */
    timers = [];

    /** @type {number[]} Interval ids used by character sounds */
    audioIntervals = [];
    ...
    /** @type {string[]} Standing animation images */
    IMAGES_STANDING = [
    ...
    /** @type {string[]} Sleeping animation images */
    IMAGES_SLEEPING = [
    ...
    /** @type {HTMLAudioElement[]} Character audio elements */
    AUDIOS;
